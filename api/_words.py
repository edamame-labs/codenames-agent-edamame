"""A compact Codenames-style word pool for board generation."""

WORDS = [
    "AFRICA", "AGENT", "AIR", "ALIEN", "AMAZON", "ANGEL", "ANTARCTICA", "APPLE",
    "ARM", "ATLANTIS", "AZTEC", "BACK", "BALL", "BAND", "BANK", "BAR", "BARK",
    "BAT", "BATTERY", "BEACH", "BEAR", "BEAT", "BED", "BEIJING", "BELL", "BELT",
    "BERLIN", "BERMUDA", "BERRY", "BILL", "BLOCK", "BOARD", "BOLT", "BOMB",
    "BOND", "BOOM", "BOOT", "BOTTLE", "BOW", "BOX", "BRIDGE", "BRUSH", "BUCK",
    ...
    "COMIC", "COMPOUND", "CONCERT", "COOK", "COPPER", "COTTON", "COURT", "COVER",
    ...
    "DUCK", "DWARF", "EAGLE", "EGYPT", "EMBASSY", "ENGINE", "ENGLAND", "EYE",
    ...
    "NET", "NEW", "NIGHT", "NINJA", "NOTE", "NOVEL", "NURSE", "NUT", "OCTOPUS",
    ...
    "SINK", "SKYSCRAPER", "SLIP", "SLUG", "SMUGGLER", "SNOW", "SOCK", "SOLDIER",
